...
import { ArrowLeftIcon, PaperPlaneRightIcon, CodeIcon, WarningIcon } from '@phosphor-icons/react';
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[60px_1fr_350px] lg:grid-rows-[48px_1fr] min-h-screen lg:h-screen lg:overflow-hidden max-w-full relative z-10">
        ...
        <main className="p-4 lg:p-8 flex flex-col gap-10 overflow-visible lg:overflow-y-auto w-full">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6 border-b border-ink-secondary/20 dark:border-border pb-6">
            <div>
              <Link href="/community" className="inline-flex items-center gap-2 text-[10px] uppercase tracking-widest font-bold text-ink-secondary hover:text-ink-primary transition-colors mb-4">
              ...
              <p className="text-ink-secondary mt-2 max-w-xl text-sm font-mono">
                Initiate a new global protocol. All active operatives will receive broadcast.
              </p>
            </div>
          </div>
          ...
          <div className="max-w-4xl mx-auto w-full flex flex-col gap-6">
            ...
            <div className="border border-ink-primary bg-surface/50 p-6 md:p-8 relative">
                ...
                <form className="space-y-8 relative z-10" onSubmit={(e) => e.preventDefault()}>
                   ...
                   {/* Title Input */}
                   <div>
                     <label className="block text-[10px] uppercase tracking-widest font-bold text-ink-primary mb-2">Subject Header</label>
                   ...
                   {/* Category Select */}
                   <div>
                     <label className="block text-[10px] uppercase tracking-widest font-bold text-ink-primary mb-2">Transmission Category</label>
                     <select className="w-full bg-bg-base border border-ink-secondary/50 p-3 font-mono text-sm text-ink-primary focus:border-ink-primary focus:outline-none transition-colors appearance-none cursor-pointer">
                   ...
                   <div>
                     <div className="flex justify-between items-end mb-2">
                        <label className="block text-[10px] uppercase tracking-widest font-bold text-ink-primary">Payload Buffer</label>
