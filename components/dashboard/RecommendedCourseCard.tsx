...
export function RecommendedCourseCard({ course }: RecommendedCourseCardProps) {
  return (
    <div className="card border border-ink-secondary relative bg-bg-surface transition-all duration-200 hover:border-ink-primary hover:shadow-[4px_4px_0_rgba(13,20,18,0.1)] hover:bg-ink-primary/5 hover:-translate-x-0.5 hover:-translate-y-0.5 grid grid-cols-[100px_1fr] min-h-[160px] rounded-none group">
      {/* Corner brackets */}
      ...
      <div className="border-r border-ink-secondary/20 relative flex items-center justify-center bg-ink-secondary/5">
        ...
        <Target size={32} className="text-ink-secondary group-hover:text-ink-primary transition-colors relative z-10" weight="duotone" />
