  ...
  return (
    <section className="grid grid-cols-1 md:grid-cols-2 border-b border-ink-primary">
      <div className="p-16 border-r border-ink-primary flex flex-col gap-6">
        <Cpu size={32} />
        <h3 className="font-display font-bold leading-[0.9] -tracking-[0.02em] text-[32px]">ON-CHAIN PROOFS</h3>
      ...
      <div className="p-16 flex flex-col gap-6">
        <Terminal size={32} />
        <h3 className="font-display font-bold leading-[0.9] -tracking-[0.02em] text-[32px]">LIVE COMPILER</h3>
        <p className="text-ink-secondary">
