...
export function LearningPaths() {
  ...
  // Mock progress data for the different tracks
  const tracks = [
    {
      key: "beginner",
      progress: 1, // 1 active out of 4 modules/steps
    },
    {
      key: "intermediate",
      progress: 2, // 2 active out of 4 modules/steps
    },
    {
      key: "advanced",
      progress: 3, // 3 active out of 4 modules/steps
    },
  ];
