...
const testimonials = [
  {
    id: 1,
    quote: "The Superteam Academy curriculum didn't just teach me syntax—it taught me how to think in parallel execution. I went from a web2 dev to shipping my first DeFi protocol in 3 months.",
    author: "CYPHER_DOG",
  ...
  {
    id: 2,
    quote: "The depth of understanding you get here is unmatched. It's not just about writing code; it's about architecting scalable systems on Solana. Truly a 10x developer accelerator.",
    author: "0xMERT",
    role: "Founder @ Helius",
    color: "#e84142"
  },
  {
    id: 3,
    quote: "Coming from Ethereum, the account model was confusing until I took this course. The mental model shifts were explained perfectly. Now I'm building high-frequency trading bots.",
    author: "SARAH_DEV",
        ...
        <AnimatePresence mode="wait">
          ...
          >
            ...
            <div className="flex items-center gap-4">
              ...
              />
              <div>
                <div className="font-bold uppercase tracking-widest">{testimonials[currentIndex].author}</div>
