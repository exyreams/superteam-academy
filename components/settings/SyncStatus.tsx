    ...
    <div className="border border-ink-primary p-4 relative">
      ...
      <div className="mt-3 flex flex-col gap-1">
        <div className="text-[10px]">
          <span className="text-ink-secondary">LAST SYNC:</span> {status.lastSync}
        </div>
        <div className="text-[10px]">
          <span className="text-ink-secondary">INTEGRITY:</span> {status.integrity}
        </div>
        <div className="text-[10px]">
          <span className="text-ink-secondary">ENCRYPTION:</span> {status.encryption}
        </div>
      </div>
    </div>
  );
