...
export const mockCourseDetail: CourseDetail = {
  ...
  ref: 'SOL-001',
  category: 'DEV-101',
  description: 'A comprehensive guide to the Solana blockchain. Learn about accounts, programs, and how to build high-performance decentralized applications using the Sealevel runtime.',
  instructor: {
  ...
  modules: [
    {
      ...
      description: 'Understanding Solana\'s core architecture and design principles',
      duration: '2.5 hours',
      completed: 2,
      total: 3,
      lessons: [
  ...
  reviews: [
    {
      ...
      comment: 'Clear explanations of PoH. Perfect for developers moving from EVM.',
      date: '2026-01-15',
    },
    {
      id: 'rev-2',
      ...
      rating: 4,
      title: 'SOLID CONTENT',
      comment: 'The account model section cleared up a lot of my confusion. Highly recommended.',
      date: '2026-01-10',
    },
    {
      id: 'rev-3',
      ...
      comment: 'The instructor knows his stuff. Coding challenges are tough but fair.',
      date: '2026-01-05',
    },
  ],
};
