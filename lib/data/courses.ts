...
export const mockCourses: Course[] = [
	{
		...
		title: "RUST SYNTAX",
		description:
			"Memory safety without garbage collection. The basics of Rust.",
		category: "rust",
		difficulty: "beginner",
		duration: "4H 30M",
		durationMinutes: 270,
	...
	},
	{
		...
		title: "ACCOUNT MODEL",
		description:
			"Everything is an account. Deep dive into the Solana storage model.",
		category: "core",
	...
	},
	{
		...
		description:
			"Common attack vectors and how to prevent them in your programs.",
		category: "security",
		difficulty: "advanced",
		duration: "8H 00M",
		durationMinutes: 480,
